...
def ensure_directories(*dirs) -> bool:
  
    for directory in dirs:
        os.makedirs(directory, exist_ok=True)
    return True

def handle_file_upload(uploaded_file) -> Optional[Union[str, bytes]]:
...
def create_download_link(content: str, filename: str, text: str = "Download") -> str:
